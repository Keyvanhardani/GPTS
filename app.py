...
# News via NewsAPI
# --------------------------------------------------------------------
# https://newsapi.org/v2/everything?q=2025&from=2024-12-25&to=2024-12-25&sortBy=popularity&apiKey=xxxx
# https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=xxxx
...
def create_multiline_subtitles(scene_text, video_width, video_height):
    ...
    subtitle_font_size = int(video_height * 0.035)   
    subtitle_box_width = int(video_width * 0.8)     
    subtitle_y_offset = video_height - 225           
